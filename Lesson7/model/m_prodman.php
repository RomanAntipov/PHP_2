...
if (isset($_GET['action'])) {
	switch ($_GET['action']) {
		...
		case ($_GET['action'] == 'add'):
			$obj = new manageProd($sqlconf);
    		$addNew = $obj->addNewProduct($_SESSION['newProduct']['prodname'], $_SESSION['newProduct']['price'], 'img/'.$_SESSION['newProduct']['image']);
		...
		case ($_GET['action'] == 'delete'):
			$obj = new manageProd($sqlconf);
    		$addNew = $obj->killProduct($_GET['id']);
