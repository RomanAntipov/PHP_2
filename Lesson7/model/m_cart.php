<?php
    // session_start();
    include 'model/getCatalog.class.php';
    ...
    elseif (isset($_GET['count'])) $prodCount = $_GET['count'];
    // на случай, если $prodCount не определён в другом месте, устанавливаем заведомо большое число.

    if ($prodCount == NULL) $prodCount = 10000; 
